this.PATHS = [
	...
	{type: 'ajax', url: 'invoices/app/buyersGroups/l10n.ru.json', name: 'buyersGroups.ru', namespace: 'l10n.ru', sync: true},
    ...
    {type: 'ajax', url: 'invoices/app/goodsGroups/l10n.ru.json', name: 'goodsGroups.ru', namespace: 'l10n.ru', sync: true},
    ...
    {type: 'ajax', url: 'invoices/app/merchant/l10n.ru.json', name: 'merchant.ru', namespace: 'l10n.ru', sync: true},
    {type: 'ajax', url: 'invoices/app/merchant/l10n.ua.json', name: 'merchant.ua', namespace: 'l10n.ua', sync: true},
